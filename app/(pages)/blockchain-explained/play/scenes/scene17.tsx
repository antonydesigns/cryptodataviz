...
export default function Scene17() {
  ...
  const textContent = {
    heading: "",
    body: [
      `In Proof of Stake, each validator must deposit a large sum of crypto assets to prove that they are committed to do their job properly. So, <strong>a lot is at stake</strong> to maintain the network's integrity.
      `,
